...
class plgSystemRokGallery extends JPlugin {
	...
	public function onAfterInitialise()
	{
		...
		else if (!preg_match('/project.version/',ROKCOMMON) && version_compare(preg_replace('/-SNAPSHOT/','',ROKCOMMON),'2.1', '<'))
		{
			$error_string = 'RokGallery needs at least RokCommon Version 2.1.  You currently have RokCommon Version ' . ROKCOMMON;
		}
