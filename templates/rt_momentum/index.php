...
$pageStyle = JRequest::getVar('Itemid') == 101 ? '_home' : '_inside';
...
<!-- VARIABLE HEADER -->            
            <div id="header<?php echo $pageStyle; ?>">
            	<div id="left"></div>
            	<div class="rt-container">
                	<div id="menutop">
                    	<?php echo $gantry->displayModules('menutop','basic','standard'); ?>
                    </div>  
                    <div id="guts-tagline"></div>  
                	<div id="graphic-header">
						<?php echo $gantry->displayModules('graphic-header', 'basic', 'standard'); ?>
                        <!--<jdoc: include type="modules" name="header-graphic" style="xhtml" /> -->
                    </div>
                    <div id="rt-topbar">
                            ...
                            <?php /** End Logo **/ endif; ?>
                            <?php /** Begin Main Navigation **/ if ($gantry->countModules('navigation')) : ?>
                            <div id="rt-navigation">
                                <?php echo $gantry->displayModules('navigation','basic','menu'); ?>
                            </div>
                            <?php /** End Main Navigation **/ endif; ?>
                        </div>
                    </div>
                    <div id="right"></div> 
                </div>
        ...
        <?php /** Begin Footer Section **/ if ($gantry->countModules('bottom') or $gantry->countModules('footer')) : ?>
				<div id="rt-footer-surround">
					...
					<div id="rt-footer" class="main-bg">
                        <div class="rt-container">
                            <?php echo $gantry->displayModules('footer','standard','limited'); ?>
                            <div class="clear"></div>
                        </div>
					</div>
