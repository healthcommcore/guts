...
class RokCommonc9a84e125de0d0113e919b80ee1fde19ServiceContainer extends RokCommon_Service_ContainerImpl
{
  ...
  protected function get_c9224851c3e6ee572fdc55463871ca661Service()
  {
    if (isset($this->shared['_c9224851c3e6ee572fdc55463871ca66_1'])) return $this->shared['_c9224851c3e6ee572fdc55463871ca66_1'];

    $class = $this->getParameter('rokgallery_config.platform.class');
    $instance = new $class();

    return $this->shared['_c9224851c3e6ee572fdc55463871ca66_1'] = $instance;
  }

  protected function getRokgalleryConfigService()
  {
    if (isset($this->shared['rokgallery_config'])) return $this->shared['rokgallery_config'];

    $instance = new RokGallery_Config($this->getService('_c9224851c3e6ee572fdc55463871ca66_1'));

    return $this->shared['rokgallery_config'] = $instance;
  }
  ...
  protected function getDefaultParameters()
  {
    return array(
      ...
      '%rokgallery_config' => array(
        'platform' => array(
          'class%' => 'RokGallery_Config_Platform_Unsupported',
        ),
      ),
      'rokgallery_config' => array(
        'platform' => array(
          'class' => 'RokGallery_Config_Joomla16',
        ),
      ),
    );
  }
